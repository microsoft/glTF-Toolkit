...
namespace Microsoft.glTF.Toolkit.UWP.Test
{
    ...
    public class UWPTest
    {
        ...
        public async Task GLBConvertToWindowsMR()
        {
            ...
            var converted = await WindowsMRConversion.ConvertAssetForWindowsMR(sourceGlbFile, outputFolder, 512, TexturePacking.OcclusionRoughnessMetallic, true, true, true);
